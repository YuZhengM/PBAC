...
class MyModelWithoutMask(nn.Module):
    def __init__(self, num_gene):
        super(MyModelWithoutMask, self).__init__()

        # 全连接层
        self.dense = nn.Linear(num_gene, 512)
...
def without_mask(data_train, label_train,data_test, label_test):
